...
// code to set the randomization logic:
...
async function editImage(image, imagePath, fact) {
  try {
    ...
    let imgDarkener = await new jimp(animalImageWidth,animalImageHeight,
      "#000000"
    );
...
//code to delete the image from your file structure:
